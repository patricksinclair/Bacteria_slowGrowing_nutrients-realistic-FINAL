...
public class BioSystem {
    ...
    public static void exponentialGradient_spatialAndGRateDistributions(double input_alpha){
        ...
        String filename_precise = "slowGrowers-alpha="+String.valueOf(alpha)+"-spatialDistribution_precise-FINAL";
        String filename_gRate_precise = "slowGrowers-alpha="+String.valueOf(alpha)+"-gRateDistribution_precise-FINAL";
